...
How about this: {(0,1), (1,0), (2,2)}? NO

Now suppose that we have a relation, r, over a set
of values, {0, 1, 2, 3, 4, 5}. Is this relation
reflexive? {} UNIVERSAL GENERALIZATION OVER THE EMPTY SET → TRUE
What about this? {(0, 1), (2, 3)} No, duh; irreflexive. None of 
these are related to themselves.
...
NO. try {(0,1), (1,0), (0,2), (2,0), (1,2), (2,1)}
-/  
